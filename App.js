...
//        this._addFeatureGrid(this, 'ReadyFeatures', this._filterByState('Defined'), PROJECT_BUSINESS, false);
        ...
        this._addAvg(this,"Iteration",this._filterLastSixWeeksOfIterations(),PROJECT_ECMLDR_TEAMS,"ECM/LDR","PlannedVelocity");
        this._addAvg(this,"Iteration",this._filterLastSixWeeksOfIterations(),PROJECT_ECMLDR_TEAMS,"ECM/LDR","PlanEstimate");
        ...
        Ext.create('Rally.data.wsapi.Store', {
            ...
            listeners: {
                load: function(store, records) {
                    ...
                    if (rows>0){
                        container._addLine(container, message + 'average ' + field + ': ' + (total/rows).toFixed(2));
                    }
                }
            }
        });
